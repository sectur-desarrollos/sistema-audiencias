...
<body>
    <div class="recibo">
        <!-- Encabezado -->
        <div class="header">
            <img src="{{ public_path('assets/audiencia/pdf/humanismo.png') }}" alt="Logo Izquierdo" class="logo-left">
            <p class="title">
                SOLICITUD DE AUDIENCIA
            </p>
            <img src="{{ public_path('assets/audiencia/pdf/turismo.png') }}" alt="Logo Derecho" class="logo-right">
        </div>
