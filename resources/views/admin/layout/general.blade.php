...
<head>
    ...
    {{-- Theme JS --}}
    <script src="{{asset('assets/bootstrap/assets_general/js/color-modes.js')}}"></script>

    <meta charset="utf-8">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Sistemas de Audiencia">
    ...
    <title>Sistema de Audiencia</title>
    ...
    {{-- Bootstrap General --}}
    <link href="{{asset('assets/bootstrap/assets_general/dist/css/bootstrap.min.css')}}" rel="stylesheet">

    {{-- Bootstrap dashboard --}}
    <link href="{{asset('assets/bootstrap/assets_dashboard/dashboard.css')}}" rel="stylesheet">
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">SECTUR CHIAPAS</a>
            ...
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">SECTUR CHIAPAS</h5>
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="{{route('audiences.index')}}">
                                    <svg class="bi">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2" href="{{ route('audiences.filter.view') }}">
                                    <svg class="bi">
                                        <use xlink:href="#file-earmark" /></svg>
                                    Filtros y Reportes
                                </a>
                            ...
                            <li class="nav-link">
                                <label for="" id="catalogsDropdown" role="button" data-bs-toggle="collapse" data-bs-target="#catalogsMenu" aria-expanded="false" aria-controls="catalogsMenu">
                                    <svg class="bi">
                                ...
                                <ul class="collapse list-unstyled ps-3" id="catalogsMenu">
                                    ...
                                    <li>
                                        <a class="nav-link d-flex align-items-center gap-2" href="{{route('dependencies.index')}}">
                                            <svg class="bi">
                                                <use xlink:href="#file-earmark" />
                                            </svg>
                                            Dependencias
                                    ...
                                    <li>
                                        <a class="nav-link d-flex align-items-center gap-2" href="{{route('audience-statuses.index')}}">
                                            <svg class="bi">
                                                <use xlink:href="#file-earmark" />
                                            </svg>
                                            Audiencia estado
                            ...
                            <li class="nav-item">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="btn btn-link nav-link d-flex align-items-center gap-2 text-danger">
                                        <svg class="bi">
    ...
    {{-- Bootstrap Dashbard --}}
    <script src="{{asset('assets/bootstrap/assets_dashboard/dashboard.js')}}"></script>
